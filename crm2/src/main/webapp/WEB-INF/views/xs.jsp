		...
		<br>
				<nav class="navbar navbar-default">
				  <div class="container-fluid">
				  			<br>
				    		&nbsp;&nbsp;&nbsp;<b>视图 :</b>&nbsp;
							<b class="glyphicon glyphicon-align-justify"></b>&nbsp;<a href="${sessionScope.basePath}/user/xs.crm" ><b>全部</b></a>&nbsp;|&nbsp;
							<a href="${sessionScope.basePath}/user/meowner.crm?ownerid=${sessionScope.crmSystemUser.sid}">我负责的</a>&nbsp;|&nbsp;
							<a href="">下属负责的</a>&nbsp;|&nbsp;
							<a href="">下属创建</a>&nbsp;|&nbsp;
							<a href="">已转换线索</a>&nbsp;
							<b class="glyphicon glyphicon-time"></b>&nbsp;<a href="">今日需联系</a>&nbsp;|&nbsp;
							<a href="">本周需联系</a>&nbsp;|&nbsp;
							<a href="">本月需联系</a>&nbsp;|&nbsp;
							<a href="">7日未联系</a>&nbsp;|&nbsp;
							<a href="">15日未联系</a>&nbsp;|&nbsp;
							...
							<a href="">最近创建</a>&nbsp;|&nbsp;
							<a href="">最近修改</a>&emsp;
							<b class="glyphicon glyphicon-trash"></b>&nbsp;<a href="${sessionScope.basePath}/user/gorecycled.crm">回收站 </a>
				  </div>
				</nav>
